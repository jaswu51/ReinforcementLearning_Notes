...
** [notes] use gaussian process to represent the state transition probability, instead of making it a deterministic one

- [Learning Complex Neural Network Policies with Trajectory Optimization](http://proceedings.mlr.press/v32/levine14.pdf)
